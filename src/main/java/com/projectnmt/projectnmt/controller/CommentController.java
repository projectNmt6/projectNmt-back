...
public class CommentController {
    ...
    public ResponseEntity<List<CommentRespDto>> getCommentList(CommentReqDto commentReqDto) {
        List<CommentRespDto> commentList = commentService.getComment(commentReqDto);
